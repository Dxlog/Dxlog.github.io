document.addEventListener("DOMContentLoaded", () => {
  ...
  generatePdfButton.addEventListener("click", () => {
    ...
    doc.rect(margin, yPosition + 12, 90, 20, "F");
    doc.setTextColor("#000");
    doc.text(supplementation, margin + 5, yPosition + 20);

    doc.setFillColor("#ff6600");
    doc.roundedRect(pageWidth - 105, yPosition, 90, 10, 2, 2, "F");
    doc.setTextColor("#FFFFFF");
    doc.text("ORIENTAÇÕES", pageWidth - 100, yPosition + 7);

    doc.setFillColor("#f5f5f5");
    doc.rect(pageWidth - 105, yPosition + 12, 90, 20, "F");
    doc.setTextColor("#000");
    doc.text(guidance, pageWidth - 100, yPosition + 20);
